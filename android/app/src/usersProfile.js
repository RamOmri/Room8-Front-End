...
import { StyleSheet, View, Text, Image,
    ...
    constructor(props){
        ...
        this.state = {
            ...
            thisBiography: '',
            userIndex: this.props.route.params.userIndex,
            ...
            account: this.props.route.params.account || { 
                ...
                numberPeople: this.props.route.params.numberPeople,
                lookingFor: this.props.route.params.lookingFor,
                hasHousing: this.props.route.params.hasHousing,
            }
                        ...
                        > 
                            ...
                            <ScrollView contentContainerStyle = {{justifyContent: 'center', alignContent: 'center', textAlign: 'center'}}>
                                    ...
                                    GETTING TO KNOW YOU
                                        ...
                                        <Text style = {styles.subeHeader}> Please enter the details of one household member below</Text>
                                    ...
                                    <Menu>
                                            <MenuTrigger customStyles = {{
                                              ...
                                              <MenuOptions>
                                                    ...
                                                    <MenuOption onSelect={() => this.setState({thisGender: 'Other'})} >
                                                        <Text style={{color: '#1795e6', fontSize: 17}}>Other</Text>
                                                    </MenuOption>
                                        </MenuOptions>
                                    </Menu>
                                            ...
                                            <TextInput
                                                ...
                                                <View style= {styles.buttonStyle}>
                                                    ...
                                                    onPress = {()=>{
                                                       ...
                                                       if(this.state.usersProfileToComplete <= 0 && this.state.account.hasHousing){
                                                            this.props.navigation.navigate('registerStack', {params: {
                                                                account: this.state.account
                                                            }, screen: 'BuildingStructure'})
                                                       }
                                                       else if(this.state.usersProfileToComplete > 0){
                                                     
                                                           this.props.navigation.push('usersProfile',
                                                            {
                                                                account: this.state.account,
                                                                //    numberPeople: this.state.numberPeople,
                                                                    toComplete: this.state.usersProfileToComplete,
