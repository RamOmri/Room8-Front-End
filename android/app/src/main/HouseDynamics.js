     ...
     export default class HouseDynamics extends React.Component{
        ...
        updateAccount(){
            this.state.account.HouseDynamics = {
                ...
                PoliticalViews: this.state.PoliticalViews,
        ...
        render(){
                    ...
                    <ScrollView>
                        <View style={{flex: 1, flexDirection: 'row'}}>
                                ...
                                <View style = {{flexDirection: 'row', marginTop: 10}}>
                                    <Text style = {{fontSize: 18, color: 'white', marginTop: 17, marginRight: 20}}>Political Views</Text>
                                <Menu>
                                            <MenuTrigger customStyles = {{
                                                triggerText: {
                                                    color: 'white',
                                            ...
                                            }}  text={this.state.PoliticalViews} />
                                              <MenuOptions>
                                                    <MenuOption onSelect={() => this.setState({PoliticalViews: 'Moderate Left'})} >
                                                        <Text style={{color: '#1795e6', fontSize: 17}}>Moderate Left</Text>
                                                    </MenuOption>
                                                    <MenuOption onSelect={() => this.setState({PoliticalViews: 'Moderate Right'})} >
                                                        <Text style={{color: '#1795e6', fontSize: 17}}>Moderate Right</Text>
                                                    </MenuOption>
                                                    <MenuOption onSelect={() => this.setState({PoliticalViews: 'Socialist'})} >
                                                        <Text style={{color: '#1795e6', fontSize: 17}}>Socialist</Text>
                                                    </MenuOption>
                                                    <MenuOption onSelect={() => this.setState({PoliticalViews: 'Far Right'})} >
                                                        <Text style={{color: '#1795e6', fontSize: 17}}>Far Right</Text>
                                                    </MenuOption>
                                                    <MenuOption onSelect={() => this.setState({PoliticalViews: 'unspecified'})} >
                                                        <Text style={{color: '#1795e6', fontSize: 17}}>unspecified</Text>
                                                    </MenuOption>
                                        </MenuOptions>
                                    </Menu>
